document.getElementById("submit-tank").addEventListener("click", function(event){
    event.preventDefault();

    let location = document.getElementById("tank-location").value;
    let latitude = document.getElementById("tank-latitude").value;
    let longitude = document.getElementById("tank-longitude").value;
    let percentage_full = document.getElementById("percentage-full").value;
...
function createTankCard(tank){
    ...
    tankCardDiv.classList.add("cards");
